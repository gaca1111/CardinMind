...
public class Card_Generator : MonoBehaviour {
    ...
    private bool Check_Diagonal_Up_Left(Difficulty_Modifiers.CardType type, int x, int y, int place, int left, int up) {
    ...
    private bool Check_Diagonal_Down_Left(Difficulty_Modifiers.CardType type, int x, int y, int height, int place, int left, int down) {
